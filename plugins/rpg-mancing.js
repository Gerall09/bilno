let handler = async (m, { conn, usedPrefix }) => {
    ...
    if (user.pancingandurability < 50 ) return m.reply('Pancinganmu Hampir Hancur Anda Harus Memperbaiki Terlebih Dahulu Dengan Cara  *.repair*')
...
`.trim()
		...
		setTimeout(() => {
			m.reply('Kamu Sedang Memancing...\nTunggu 1 Menit Karna Lo Lagi Nunggu Ikan')
		}, 0)
