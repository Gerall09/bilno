    ...
    try {
        ...
        try {
            ...
            if (!("BannedReason" in user)) user.BannedReason = ""
              ...
              if (isNumber(user.fuel)) user.fuel = 100
              ...
              if (!isNumber(user.subscribers)) user.subscribera = 0
        ...
        for (let name in global.plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                    this.reply(m.chat, `[🚩] *Limit kamu habis, sebagian fitur terkunci Beli limit terlebih dahulu*\n\n- .shop buy limit\n- .buylimit\n- .hadiah`,)
                    continue 
                }
...
sourceUrl: "https://whatsapp.com/channel/0029VaAAkwOIN9ii1Tc6Mz1X",
mediaType: 1,
...
global.dfail = async (type, m, mufar) => {
  ...
  let daftar = {
  unreg: `Sebelum menggunakan bot registrasi terlebih dahulu.

╭─ •  「 *Tinasha Tuldar*  」
│  ○ *manual* : .daftar nama.umur
│    Contoh :  .daftar Tinasha.18
│
│  ○ *otomatis* : @verify
│    Contoh :  @verify
│
